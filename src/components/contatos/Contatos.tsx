        ...
        <Grid container direction='row'>
            <Grid xs={12} sm={12}>
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageSergio">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageMarcos">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageJanderson">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageRaphael">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageFelipe">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageSilas">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
                ...
                <Grid className="property-card">
                    <a href="#">
                        <Grid className="property-imageWallace">
                            <Grid className="property-image-title">
                            </Grid>
                        </Grid>
                    </a>
